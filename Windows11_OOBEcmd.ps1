...
$AssignedComputerName = "SVA-$TargetComputername"
...
Start /Wait PowerShell -NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/SVAEUC/OSDPadPublic/main/Set-KeyboardLanguage.ps1
...
Start /Wait PowerShell -NoL -C Invoke-WebPSScript https://raw.githubusercontent.com/SVAEUC/OSDPadPublic/main/Start-AutopilotOOBE.ps1
...
powershell.exe -Command "& {IEX (IRM https://raw.githubusercontent.com/SVAEUC/OSDPadPublic/main/oobetasks.ps1)}"
'@
